...
const StepOne: React.FC<StepOneProps> = (props: StepOneProps) => {
    ...
    const handleDropCb = (e: any) => {
        // TODO: TEMPORAL - for practical reasons, validating and parsing a simple JSON file
        const file = e.dataTransfer.files[0];
        onFileLoaded(file);
        setFileInfo(file);
        setShowOverlay(false);
        // TODO: validate the type of the file(zip), post the zip file to the api service, then parse the response
    };
    ...
    // TODO: improve the local validation function
    const fileIsValid = () => {
        if (fileInfo && fileInfo.size > DEFAULT_MAX_FILE_SIZE_IN_BYTES) {
            return false;
        }
        if (fileInfo && fileInfo.type !== 'application/json') {
            return false;
        }
        return true;
    };
        ...
        <main ref={dragAndDropRef}>
            <div className='OpenFile__openFileContent'>
                ...
                <div className='mainDescription'>
                    ...
                    />
                    <button onClick={() => onOpenFileButtonClick()} className='buttonAsLink'>
                        <FormattedMessage
...
const fileStateCompletedSection = (
    ...
    fileInfo: any) => {
    // TODO: Hardcoded data info, parse real fileInfo and put it here
    const fileInfos: any = [
        {
    ...
    // const uploadsInProgress: any = [];
    // const uploadsProgressPercent: number = 10;
    ...
    return (
        <div className= 'OpenFile__openFileCompletedContent'>
            ...
            {!usersAboveFreeTier() || isPaidTier || deactivateUsers ? <div className='satisfiedMessage'>
                ...
                />
                <button onClick={() => nextStepFunc()} className='buttonAsLink'>
                    <FormattedMessage
